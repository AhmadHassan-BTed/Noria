...
const { WhatsAppListener, SOURCE_MODE } = require('../../../../src/infrastructure/messaging/whatsapp-listener');
const { initConnectionManager } = require('../../../../src/infrastructure/messaging/connection-manager');
