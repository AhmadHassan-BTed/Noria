...
<div style="display: flex; align-items: center; justify-content: center; gap: 12px; margin-bottom: 20px;">
    <svg width="50" height="50" viewBox="0 0 299 300" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M51.5605 103.653C51.5605 100.339 54.2468 97.6532 57.5605 97.6532H101.824C105.138 97.6532 107.824 100.339 107.824 103.653V109.192C107.824 120.238 98.87 129.192 87.8243 129.192H71.5605C60.5148 129.192 51.5605 120.238 51.5605 109.192V103.653Z" fill="#212121" stroke="#25D366" stroke-width="16"/>
    ...
    <span style="color: #FFFFFF; font-family: 'Outfit', sans-serif; font-weight: 700; font-size: 34px; line-height: 50px;">Noria</span>
</div>
""", unsafe_allow_html=True)
