...
const SCHOLARSHIP_CRITERIA = {
  field_alignment: {
    points: 25,
    description:
      'Software Engineering, Computer Science, AI, Distributed Computing, or Advanced Systems.',
  },
  funding_tier: {
    points: 25,
  ...
  career_runway: {
    points: 5,
    description:
      'Host country provides post-study work visa clearance and English medium verification.',
  },
};
...
const SCHOLARSHIP_PENALTIES = [
  {
    ...
    condition: 'Applicant nationality excluded from eligibility pool',
  },
  {
    deduction: 'match_score forced to 0',
    condition: 'Program is exclusively an undergraduate/Bachelor degree tier',
  },
  {
    deduction: 'match_score forced to 0',
    condition: 'Degree discipline is unaligned with target computing engineering tracks',
  },
];
