...
/**
 * Scholarship Domain — Prompt Builder
 *
 ...
 * @returns {object} Applicant profile with scholarship-specific defaults
 */
function resolveProfile(appConfig) {
  return {
    name: appConfig.APPLICANT_NAME || 'Ahmad Hassan',
    nationality: appConfig.APPLICANT_NATIONALITY || 'Pakistani',
    degreeTier: appConfig.APPLICANT_DEGREE_TIER || 'Master',
    targetFields:
      appConfig.APPLICANT_TARGET_FIELDS ||
      'Software Engineering, Computer Science, AI, Distributed Computing',
    researchFocus:
      appConfig.APPLICANT_RESEARCH_FOCUS ||
      'Federated Learning, on-device AI, distributed computation systems',
  };
}

/**
 * Builds the LLM analysis prompt for scholarship evaluation.
 *
